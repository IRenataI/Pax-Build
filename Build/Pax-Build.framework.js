...
var ASM_CONSTS = {
  3461228: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 3461283: function($0) {performance.now = function() { return $0; };},  
 3461331: function($0) {performance.now = function() { return $0; };},  
 3461379: function() {performance.now = Module['emscripten_get_now_backup'];},  
 3461434: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 3461495: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 3461559: function() {return Module.webglContextAttributes.powerPreference;}
};
  ...
  function _UnityPluginRequestJs() 
              {
                  FromUnityToJs ();
              }

  function _UnityPluginRequestUserData() 
              {
                  JSRequestUserData ();
              }
...
var asmLibraryArg = {
  ...
  "UnityPluginRequestJs": _UnityPluginRequestJs,
  "UnityPluginRequestUserData": _UnityPluginRequestUserData,
